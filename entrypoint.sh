...
UUID=${UUID:-'c1449bbf-08cc-4c99-a495-6fa1458f9b4a'}
VMESS_WSPATH=${VMESS_WSPATH:-'/c1449bbf-08cc-4c99-a495-6fa1458f9b4a-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/c1449bbf-08cc-4c99-a495-6fa1458f9b4a-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/c1449bbf-08cc-4c99-a495-6fa1458f9b4a-trojan'}
SS_WSPATH=${SS_WSPATH:-'/c1449bbf-08cc-4c99-a495-6fa1458f9b4a-shadowsocks'}
